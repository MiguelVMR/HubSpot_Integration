 ...
 */
@Component
final class ContatoHttpClientImpl implements ContatoHttpClient {
    private final CustomModelConfig customModelConfig;
    private final RestClient restClient;

    public ContatoHttpClientImpl(CustomModelConfig customModelConfig, RestClient.Builder restClient) {
